...
load_plugin --user jeffreytse --hash 91cafe4a09b6670cb8e761aa413e5f7b9e00816f --patch zsh-vi-mode
...
setopt PROMPT_SUBST
NEWLINE=$'\n'
PROMPT='%F{blue}%T%f %F{#D1FFBD}%n%f@${PROMPT_M} %B%F{cyan}%~%f%b %F{#FFA500}${vcs_info_msg_0_}%f%F{#0000FF}${CC%% *}%f${NEWLINE}%B%F{green}❯%f%b '
